defmodule ClientTestApp.SuperSeed.Farming.HealthRecords.Treatment do
  @behaviour SuperSeed.Inserter

  alias ClientTestApp.Support.Builders.HealthRecord
  alias ClientTestApp.SuperSeed.Farming.Animals.Thunder
